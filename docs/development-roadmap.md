...
| M5 Differentiated audit UI | M5-4 complete; M5-5 deferred behind M1 closeout | 2026-07-10 to 2026-07-16 | Add lifecycle, state changes, archives, cover/loss, epochs, and provenance integration | Audit views complete without baseline regressions |
...
Status: complete in PR #38 (`7faf39d7217ce6e7438346e478a6416243929dd9`).
...
Status: complete in PR #40 (`d59859af3425f7b7c63c3f54b18452a234264c4f`).
...
Status: deferred until M1 closeout real-data activation is complete or explicitly blocked at an accepted external gate.
