...
} from '../src/shared/supabase-revision4-catchup-convergence'
...
function usage(): string {
  return [
    'Usage:',
    '  node r4f-revision4-catchup-convergence-verifier.mjs --input <path> [--output <path>] [--require-proof-ready]',
    '',
...
function main(): void {
  ...
  ) as SupabaseRevision4CatchupConvergenceInput
