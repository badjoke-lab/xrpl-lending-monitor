...
const futureDemandSummary = await readFile(`${outputDir}/revision3-future-demand-summary.md`, 'utf8')
await appendFile(`${outputDir}/legacy-rev3-caller-summary.md`, `\n${futureDemandSummary}`)
console.log(futureDemandSummary.trimEnd())
