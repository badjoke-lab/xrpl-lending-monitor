...
} from '../src/shared/supabase-revision4-restore-operator-independence'
...
function usage(): string {
  return [
    'Usage:',
    '  node r4f-revision4-restore-operator-verifier.mjs --input <path> [--output <path>] [--require-proof-ready]',
    '',
