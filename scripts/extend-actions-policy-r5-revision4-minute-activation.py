...
replace_once(
    'minute activation and resource diagnostic workflow allowlist entries',
...
replace_once(
    'minute activation and resource diagnostic workflow count',
...
replace_once(
    'minute activation and resource diagnostic workflow symbols',
...
replace_once(
    'minute activation and resource diagnostic trigger policy',
